...
namespace FASTSURVEY.Services.Anexo
{
    ...
    {
        Task<ServiceResult<AnexoResponse>> UploadAsync(
        ...
        Task<ServiceResult<List<AnexoResponse>>> ListByPesquisaAsync(
            int pesquisaId,
            CancellationToken ct = default
        );

        Task<ServiceResult<List<AnexoResponse>>> ListByPerguntaAsync(
            int perguntaId,
            CancellationToken ct = default
        );
        ...
        Task<ServiceResult<(byte[] Bytes, string ContentType, string FileName)>> DownloadAsync(
            int id,
            CancellationToken ct = default
        );
    }
