...
function ActionsAside({
  ...
  return (
    <aside className={`${styles.actionsPanel} ${styles.noPrint}`} aria-label="Ações da pesquisa">
  ...
  return (
    <>
      ...
      <main className={styles.page}>
        <div
          className={`${styles.tabsContainer} ${styles.pageTabs}`}
          role="tablist"
          aria-label="Visão dos resultados"
        >
          <button
            type="button"
            ...
            role="tab"
            aria-selected={abaAtiva === 'pesquisa'}
          >
            Pesquisa
          </button>
          <button
        ...
        {abaAtiva === 'pesquisa' ? (
          ...
          <section
            className={`${styles.chartsSection} ${styles.noPrint}`}
            aria-label="Gráficos e insights da pesquisa"
          >
            <ResultadosCompletos pesquisaId={id} />
          </section>
        )}
