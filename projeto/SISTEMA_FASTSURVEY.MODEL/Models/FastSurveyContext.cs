...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<anexos>(entity =>
            {
                ...
                entity.Property(e => e.extensao).IsRequired().HasMaxLength(25);
            ...
            modelBuilder.Entity<login>(entity =>
            {
                ...
                entity.Property(e => e.usuario).IsRequired().HasMaxLength(255);
            ...
            modelBuilder.Entity<pesquisas>(entity =>
            {
                ...
                // "TemplateJson" foi criada com aspas no PostgreSQL => respeitar case
                entity.Property(e => e.TemplateJson)
                      .HasColumnName("TemplateJson");

                // Data de criação com default no banco
                entity.Property(e => e.datacriacao)
                      .HasColumnType("timestamp without time zone")
                      .HasDefaultValueSql("CURRENT_TIMESTAMP");

                // (Opcional) se existir no banco
                entity.Property(e => e.dataatualizacao)
                      .HasColumnType("timestamp without time zone");

                // (Opcional) índice p/ consultas por período
            ...
            modelBuilder.Entity<respostas>(entity =>
            {
                ...
                // ===== respostas ↔ anexos (JOIN TIPADO) =====
                entity.HasMany(d => d.anexo)
                      .WithMany(p => p.resposta)
                      .UsingEntity<respostas_anexos>(
                          j => j.HasOne(x => x.anexo)
                                .WithMany()
                                .HasForeignKey(x => x.anexoid)
                                .OnDelete(DeleteBehavior.ClientSetNull)
                                .HasConstraintName("respostas_anexos_anexoid_fkey"),
                          j => j.HasOne(x => x.resposta)
                                .WithMany()
                          ...
                          j =>
                          {
                              ...
                              j.HasKey(x => new { x.respostaid, x.anexoid })
                               .HasName("respostas_anexos_pkey");
                          });

                // ===== respostas ↔ opcoespergunta (JOIN TIPADO) =====
                entity.HasMany(d => d.opcao)
                      .WithMany(p => p.resposta)
                      .UsingEntity<respostas_opcoes>(
                          j => j.HasOne(x => x.opcao)
                                .WithMany()
                          ...
                          j =>
                          {
                              ...
                              j.HasKey(x => new { x.respostaid, x.opcaoid })
                               .HasName("respostas_opcoes_pkey");
                              j.HasIndex(x => x.opcaoid, "idx_respostasopcoes_opcaoid");
                              j.HasIndex(x => x.respostaid, "idx_respostasopcoes_respostaid");
                          });
            });
            ...
            // Removido: configuração duplicada explícita de respostas_anexos / respostas_opcoes
